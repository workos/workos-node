...
describe('SSO', () => {
  describe('SSO', () => {
    describe('getAuthorizationURL', () => {
      describe('with no custom api hostname and clientID', () => {
      ...
      describe('with no custom api hostname and projectID', () => {
        it('generates an authorize url with the default api hostname', () => {
          const workos = new WorkOS('sk_test_Sz3IQjepeSWaI4cMS4ms4sMuU');
      ...
      describe('with no domain or provider and clientID', () => {
      ...
      describe('with no domain or provider and projectID', () => {
        it('throws an error for incomplete arguments', () => {
          const workos = new WorkOS('sk_test_Sz3IQjepeSWaI4cMS4ms4sMuU');
      ...
      describe('with a provider and clientID', () => {
      ...
      describe('with a provider and projectID', () => {
        it('generates an authorize url with the provider', () => {
          const workos = new WorkOS('sk_test_Sz3IQjepeSWaI4cMS4ms4sMuU', {
            apiHostname: 'api.workos.dev',
          });
      ...
      describe('with a custom api hostname and clientID', () => {
      ...
      describe('with a custom api hostname and projectID', () => {
        it('generates an authorize url with the custom api hostname', () => {
          const workos = new WorkOS('sk_test_Sz3IQjepeSWaI4cMS4ms4sMuU', {
            apiHostname: 'api.workos.dev',
          });
      ...
      describe('with state and clientID', () => {
    ...
    describe('with state and projectID', () => {
      it('generates an authorize url with the provided state', () => {
        const workos = new WorkOS('sk_test_Sz3IQjepeSWaI4cMS4ms4sMuU');
  ...
  describe('getProfile and clientID', () => {
  ...
  describe('getProfile and projectID', () => {
    describe('with all information provided', () => {
      it('sends a request to the WorkOS api for a profile', async () => {
        const mock = new MockAdapter(axios);
        mock.onPost('/sso/token').reply(200, {
