...
export class AuditLogs {
   ...
   * @returns {Promise<AutoPaginatable<AuditLogAction>>}
   * @throws {NotFoundException} 404
   * @throws {UnprocessableEntityException} 422
   */
  async listActions(
   ...
   * @returns {Promise<AutoPaginatable<AuditLogSchema>>}
   * @throws {NotFoundException} 404
   * @throws {UnprocessableEntityException} 422
   */
   ...
   * @param options.actors - (deprecated) Deprecated. Use `actor_names` instead.
   * @example ["Jon Smith"]
