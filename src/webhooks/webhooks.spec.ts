  ...
  describe('constructEvent', () => {
    describe('with the correct payload, sig_header, and secret', () => {
      it('returns a webhook event', () => {
        let sigHeader = `t=${timestamp}, v1=${signatureHash}`;
        let webhook = workos.webhooks.constructEvent(
          payload,
          sigHeader,
          secret,
        );
    ...
    describe('with the correct payload, sig_header, secret, and tolerance', () => {
     ...
     describe('with an empty header', () => {
       it('raises an error', () => {
         let sigHeader = "";
         expect(() => workos.webhooks.constructEvent(
           payload,
           sigHeader,
           secret,
     ...
     describe('with an incorrect signature hash', () => {
       it('raises an error', () => {
         let sigHeader = `t=${timestamp}, v1=99999`;
         expect(() => workos.webhooks.constructEvent(
           payload,
           sigHeader,
           secret,
