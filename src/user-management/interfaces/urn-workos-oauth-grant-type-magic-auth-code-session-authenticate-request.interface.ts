...
export interface UrnWorkosOAuthGrantTypeMagicAuthCodeSessionAuthenticateRequest {
...
export interface UrnWorkosOAuthGrantTypeMagicAuthCodeSessionAuthenticateRequestResponse {
  client_id: string;
