...
export interface UrnWorkosOAuthGrantTypeMfaTotpSessionAuthenticateRequest {
...
export interface UrnWorkosOAuthGrantTypeMfaTotpSessionAuthenticateRequestResponse {
  client_id: string;
