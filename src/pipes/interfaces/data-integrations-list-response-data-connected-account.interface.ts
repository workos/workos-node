...
import type { DataIntegrationsListResponseDataConnectedAccountConnectionRole } from './data-integrations-list-response-data-connected-account-connection-role.interface';
...
export interface DataIntegrationsListResponseDataConnectedAccountResponse {
  object: 'connected_account';
  id: string;
  connection_role?: DataIntegrationsListResponseDataConnectedAccountConnectionRole;
