...
import type { DataIntegrationCustomProviderAuthenticateVia } from './data-integration-custom-provider-authenticate-via.interface';
...
export interface DataIntegrationCustomProviderResponse {
  name: string;
