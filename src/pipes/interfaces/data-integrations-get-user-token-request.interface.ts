...
import type { DataIntegrationsGetUserTokenRequestConnectionOwner } from './data-integrations-get-user-token-request-connection-owner.interface';
...
export interface DataIntegrationsGetUserTokenRequest {
  ...
  connectionOwner?: DataIntegrationsGetUserTokenRequestConnectionOwner;
