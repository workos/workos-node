...
describe('Organizations', () => {
  ...
  describe('getAuditLogRetention', () => {
    it('returns the audit log retention for an organization', async () => {
      fetchOnce({ retention_period_in_days: 365 });

      const retention = await workos.organizations.getAuditLogRetention(
        'org_01EHT88Z8J8795GZNQ4ZP1J81T',
      );

      expect(fetchURL()).toContain(
        '/organizations/org_01EHT88Z8J8795GZNQ4ZP1J81T/audit_logs_retention',
      );
  ...
  describe('setAuditLogRetention', () => {
    it('sets the audit log retention for an organization', async () => {
      fetchOnce({ retention_period_in_days: 30 });

      const retention = await workos.organizations.setAuditLogRetention({
        organizationId: 'org_01EHT88Z8J8795GZNQ4ZP1J81T',
  ...
  describe('getAuditLogConfiguration', () => {
    describe('without a log stream', () => {
      it('returns the audit log configuration for an organization', async () => {
        fetchOnce({
        ...
        const configuration =
          await workos.organizations.getAuditLogConfiguration(
            'org_01EHT88Z8J8795GZNQ4ZP1J81T',
          );

        expect(fetchURL()).toContain(
          '/organizations/org_01EHT88Z8J8795GZNQ4ZP1J81T/audit_log_configuration',
        );
    ...
    describe('with a log stream', () => {
      it('returns the audit log configuration with log stream details', async () => {
