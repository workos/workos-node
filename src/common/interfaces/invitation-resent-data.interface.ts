...
import type { InvitationResentDataState } from './invitation-resent-data-state.interface';
...
export interface InvitationResentData {
  ...
  state: InvitationResentDataState;
...
export interface InvitationResentDataResponse {
  object: 'invitation';
  id: string;
  email: string;
  state: InvitationResentDataState;
