...
} from './flag-rule-updated-data-owner.interface';

/** The event payload. */
export interface FlagRuleUpdatedData {
  object: 'feature_flag';
  ...
  owner: FlagRuleUpdatedDataOwner | null;
...
export interface FlagRuleUpdatedDataResponse {
  object: 'feature_flag';
  id: string;
  ...
  name: string;
  description: string | null;
  owner: FlagRuleUpdatedDataOwnerResponse | null;
  tags: string[];
  enabled: boolean;
