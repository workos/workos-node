...
import type { InvitationRevokedDataState } from './invitation-revoked-data-state.interface';
...
export interface InvitationRevokedData {
  ...
  state: InvitationRevokedDataState;
...
export interface InvitationRevokedDataResponse {
  object: 'invitation';
  id: string;
  email: string;
  state: InvitationRevokedDataState;
